...
const CartDrawer = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed w-[94%] md:w-[600px] h-[calc(100vh-120px)] md:h-[calc(100%-150px)] md:top-[150px] right-0 md:right-[3%] bg-white shadow-lg z-50 transition-transform duration-1000 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-[200%]'} overflow-y-scroll`}>
