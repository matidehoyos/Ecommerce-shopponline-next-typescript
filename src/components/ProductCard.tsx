...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <Link
      ...
      className="group w-full md:min-w-[250px] md:max-w-[250px] p-1 md:p-2 flex flex-col items-center border border-gray-400 rounded-lg bg-white md:mb-0 md:hover:border-gray-500 md:hover:shadow-md md:hover:shadow-gray-600 transition-all duration-500"
    >
      <div
