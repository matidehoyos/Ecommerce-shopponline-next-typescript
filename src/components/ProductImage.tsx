...
const ProductImage: React.FC<ProductImageProps> = ({ images, selectedImage, setSelectedImage }) => {
  ...
  return (
    <div className="md:w-[90%] px-[3%] md:px-0 pt-4 md:pt-0 flex flex-col-reverse md:flex-row items-center md:items-strech justify-center md:justify-end">
      ...
      <div className="md:ml-4 relative group md:w-[50%] flex items-center justify-center h-auto bg-transparent md:bg-gray-50 md:border border-gray-300">
        {selectedImage ? (
          <Image
            ...
            height={500}
            priority
            className="w-full object-scale-down md:object-contain h-[240px] md:h-auto md:scale-90 transition-all duration-1000 ease-in-out transform md:group-hover:scale-[1.6]"
          />
        ) : (
